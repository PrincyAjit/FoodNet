...
class RecipeCategory(models.Model):
	...
	class Meta:
		verbose_name_plural="Recipe Catogories"
...
class GeneralRecipe(models.Model):
	...
	category=models.ForeignKey(RecipeCategory,null=True,verbose_name="RecipeCategory",on_delete=models.SET_NULL) #ondelete -> if a particular category is deleted, then the default category value (1) is placed  
